...
- Send a test probe to `https://numista-backend-568985927038.us-central1.run.app/api/greysheet/config` — expect HTTP 200 or 401/403 (never 404 or 500).
- Send a test probe to `https://numista-backend-568985927038.us-central1.run.app/api/greysheet/pricing/<any-gsid>` — expect HTTP 200, 401, or 403 (never 404 or 500).
