...
async def scrape_gaps_cron(limit: int = 50, target: str = "all", mode: str = "request", dry_run: bool = False):
    """
    ...
    try:
        ...
        processed_coins, processed_errors = agent.run(target=target, limit=limit, dry_run=dry_run)
