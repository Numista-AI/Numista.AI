...
url = "https://www.usmint.gov/learn/coins-and-medals/collectible-coins/native-american-dollar-coins"
...
for link in links:
    ...
    # We want native american dollar visuals
    if 'native' not in filename.lower() and 'american' not in filename.lower():
        continue
...
print(f"Phase 2 and 3 executed for Native American Dollars. {downloaded_count} physical assets processed.")
