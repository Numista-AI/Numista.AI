...
#### PHASE 2: Link & Navigation Crawl (CONDITIONAL)
1. **GATEKEEPER:** Only proceed with Phase 2 and 3 if the user explicitly says "Run Full Regression" or "Full QA." If not, skip to PHASE 4.
2. Use the Browser Agent to navigate to the homepage.
3. Systematically click every internal link (Home, Collection, Add Coin, Settings, etc.).
4. Verify that no page returns a 404 error or a blank "white screen of death."
5. Ensure the navigation bar remains consistent across all views.
