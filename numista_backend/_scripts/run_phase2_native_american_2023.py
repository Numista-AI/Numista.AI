...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\Native_American"
...
# Specifically target the 2023 that dropped connection
link = "https://www.usmint.gov/content/dam/usmint/coins/native-american-one-dollar/2023-native-american-one-dollar-uncirculated-coin-reverse.jpg"
...
print(f"Extracting specific asset: {filename}...")
try:
    ...
    # Deploy to GCS
    gcs_path = f"reference_library/bulk_programs/native_american/{filename}"
    ...
    staging_df = pd.DataFrame([csv_row])
    ...
    print("Master CSV updated with the 2023 Native American reverse!")
        
except Exception as e:
    print(f"Failed extraction on retry: {e}")
