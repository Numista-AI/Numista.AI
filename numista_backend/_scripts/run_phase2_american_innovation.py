...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\American_Innovation"
...
url = "https://www.usmint.gov/learn/coins-and-medals/collectible-coins/american-innovation-dollar-coins"
...
for link in links:
    ...
    if 'innovation' not in filename.lower() and 'dollar' not in filename.lower() and 'uncirculated' not in filename.lower():
        continue
        
    gcs_path = f"reference_library/bulk_programs/american_innovation/{filename}"
    ...
    try:
        ...
        csv_rows.append({
            ...
            'tags': "American Innovation Dollar",
            'gcs_url': public_url,
            'gcs_path': gcs_path,
...
print(f"Phase 2 and 3 executed for American Innovation. {downloaded_count} physical assets processed.")
