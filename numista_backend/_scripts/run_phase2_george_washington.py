...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\Washington_Delaware"
...
url = "https://www.usmint.gov/learn/coins-and-medals/circulating-coins/quarter/general-george-washington-crossing-the-delaware-quarter"
...
for link in links:
    ...
    # We only want images roughly associated with Washington / Delaware
    if 'washington' not in filename.lower() and 'delaware' not in filename.lower():
        continue
    ...
    try:
        ...
        # Deploy to GCS
        gcs_path = f"reference_library/bulk_programs/washington_crossing_delaware/{filename}"
        ...
        csv_rows.append({
            ...
            'tags': "Washington Crossing the Delaware",
            'gcs_url': public_url,
            'gcs_path': gcs_path,
...
print(f"Phase 2 and 3 executed for Washington Crossing the Delaware. {downloaded_count} physical assets processed.")
