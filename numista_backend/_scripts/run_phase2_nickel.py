...
for link in links:
    ...
    # Restrict to nickel visuals
    if 'nickel' not in filename.lower() and 'jefferson' not in filename.lower() and 'westward' not in filename.lower() and 'monticello' not in filename.lower():
        continue
    ...
    try:
        ...
        program_tag = ""
        if "westward" in filename.lower() or "ocean" in filename.lower() or "keelboat" in filename.lower() or "bison" in filename.lower() or "peace" in filename.lower(): 
            program_tag = "Westward Journey"
        elif "buffalo" in filename.lower(): program_tag = "Buffalo Nickel"
        elif "liberty" in filename.lower(): program_tag = "Liberty Head Nickel"
        elif "shield" in filename.lower(): program_tag = "Shield Nickel"
        ...
        csv_rows.append({
            ...
            'tags': program_tag if program_tag else "Jefferson Nickel",
            'gcs_url': public_url,
            'gcs_path': gcs_path,
...
print(f"Phase 2 and 3 executed for Nickel page. {downloaded_count} physical assets processed.")
