...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\Flowing_Hair"
...
url = "https://www.usmint.gov/learn/coins-and-medals/collectible-coins/230th-anniversary-flowing-hair"
...
for link in links:
    ...
    # Very loose filter for this specific page
    if 'flowing' not in filename.lower() and 'hair' not in filename.lower() and '230' not in filename.lower() and 'dollar' not in filename.lower() and 'medal' not in filename.lower():
        continue
    ...
    try:
        ...
        # Deploy to GCS
        gcs_path = f"reference_library/bulk_programs/flowing_hair/{filename}"
        ...
        csv_rows.append({
            ...
            'tags': "Flowing Hair 230th Anniversary",
            'gcs_url': public_url,
            'gcs_path': gcs_path,
...
print(f"Phase 2 and 3 executed for Flowing Hair. {downloaded_count} physical assets processed.")
