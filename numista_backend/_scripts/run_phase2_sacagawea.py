...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\Sacagawea"
...
url = "https://www.usmint.gov/learn/coins-and-medals/circulating-coins/sacagawea-golden-dollar"
...
for link in links:
    ...
    # We only want images roughly associated with Sacagawea/Native American Dollar
    if 'sacagawea' not in filename.lower() and 'dollar' not in filename.lower():
        continue
    ...
    try:
        ...
        # Deploy to GCS
        gcs_path = f"reference_library/bulk_programs/sacagawea/{filename}"
...
print(f"Phase 2 and 3 executed for Sacagawea. {downloaded_count} physical assets processed.")
