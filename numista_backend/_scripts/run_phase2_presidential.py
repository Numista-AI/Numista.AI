...
for link in links:
    ...
    # We want presidential dollar visuals
    if 'presidential' not in filename.lower() and 'dollar' not in filename.lower() and 'reverse' not in filename.lower():
        # Keep everything here basically, it's the presidential dollar page
        pass
...
print(f"Phase 2 and 3 executed for Presidential Dollars. {downloaded_count} physical assets processed.")
