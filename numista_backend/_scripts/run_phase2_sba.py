...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\SBA"
...
url = "https://www.usmint.gov/learn/coins-and-medals/circulating-coins/susan-b-anthony-dollar"
...
for link in links:
    ...
    # Restrict to Susan B Anthony visuals
    if 'anthony' not in filename.lower() and 'sba' not in filename.lower():
        continue
    ...
    try:
        ...
        # Deploy to GCS
        gcs_path = f"reference_library/bulk_programs/sba/{filename}"
...
print(f"Phase 2 and 3 executed for SBA Dollars. {downloaded_count} physical assets processed.")
