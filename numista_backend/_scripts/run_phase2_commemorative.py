...
BASE_DIR = r"C:\Users\ericd\Documents\MyVertexProject\Manual downloaded Coin Images\US Mint\Bulk_Scrape\Commemoratives"
...
url = "https://www.usmint.gov/learn/coins-and-medals/commemorative-coins"
...
for link in links:
    ...
    gcs_path = f"reference_library/bulk_programs/commemorative/{filename}"
...
print(f"Phase 2 and 3 executed for Commemorative Coins. {downloaded_count} physical assets processed.")
