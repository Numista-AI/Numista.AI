...
"""Helper script: writes auto_annotate_checklist_dataset.py with correct UTF-8 encoding."""
...
with open("auto_annotate_checklist_dataset.py", "w", encoding="utf-8") as f:
    f.write(code)
print(f"Written {len(code)} chars to auto_annotate_checklist_dataset.py")
