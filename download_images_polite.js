...
const images = [
    ...
    { name: '2024_jefferson_nickel_obverse.jpg', url: 'https://upload.wikimedia.org/wikipedia/commons/0/00/United_States_nickel_obverse.jpg' },
...
(async () => {
    ...
    for (const image of images) {
        ...
        try {
            ...
            await page.close();
            console.log('  Waiting 5 seconds to be nice to Wikimedia...');
            await sleep(5000);
        } catch (e) {
