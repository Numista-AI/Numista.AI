...
const _versionHistory = <_Release>[
  ...
  _Release(
    ...
    changes: [
      ...
      'Frontend Flutter: 370/370 unit tests passing (100% pass rate)',
      'Dart Analyzer: 0 errors, 0 warnings across lib/',
      'Playwright Smoke: 8/8 passed under grokbot@numista.ai test account',
      'Live Cloud Run & Web App Probes: 7/7 endpoints verified healthy',
      'Model Policy: 100% compliant with 2026 Gemini GA models',
    ],
  ),
  _Release(
    version: 'v4.353',
  ...
  _Release(
    ...
    isLatest: false,
    changes: [
      'Sync release notes and version bump v4.348',
      'Audit: run full system check via project-scanner skill and update SCAN_REPORT.md (v4.349)',
    ],
  ),
  _Release(
  ...
  _Release(
    version: 'v4.344',
    date: '2026-09-10',
    description: 'Scripts Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Scripts: grokbot key migrate script - fixed Firebase init + Unicode + ran stats rebuild',
      'Import: normalize before dupe queries, dual-read fallback, migration script',
  ...
  _Release(
    version: 'v4.343',
    date: '2026-09-10',
    description: 'Import Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Import: normalize before dupe queries, dual-read fallback, migration script',
      'Cards: year sort groups by theme/subject so same-design P/D coins are adjacent',
  ...
  _Release(
    version: 'v4.342',
    date: '2026-09-10',
    description: 'Cards Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Cards: year sort groups by theme/subject so same-design P/D coins are adjacent',
      'Cards+import: reverse image priority, All-tab cached docs, CSV field normalization',
  ...
  _Release(
    version: 'v4.341',
    date: '2026-09-10',
    description: 'Cards+import Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Cards+import: reverse image priority, All-tab cached docs, CSV field normalization',
      'Export: full-fidelity JSON backup with multi-collection support (schemaVersion 2)',
  ...
  _Release(
    version: 'v4.340',
    date: '2026-09-10',
    description: 'Export Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Export: full-fidelity JSON backup with multi-collection support (schemaVersion 2)',
      'Export: resolve JSON download silent no-op â€” Timestamp serialization + web download',
  ...
  _Release(
    version: 'v4.297',
    date: '2026-09-02',
    description: 'Revert "feat(checklists) Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Revert "feat(checklists): add Westward Journey Nickel Series(tm) 2004-2005"',
      'Checklists: add Westward Journey Nickel Series(tm) 2004-2005',
  ...
  _Release(
    version: 'v4.279',
    date: '2026-09-01',
    description: 'Skills Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Skills: update project-scanner skill with prod URLs and US Mint programs',
      'E2e: fix ISSUE-002 mint set tab timeout using semantic text locator',
  ...
  _Release(
    version: 'v4.272',
    date: '2026-08-31',
    description: 'Slot_resolver Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Slot_resolver: accept \'Five Cents\'/\'5 Cents\' as nickel denomination in checklist guard',
      'Rag: reduce batch size to 10, add Phase 3 allowlist',
  ...
  _Release(
    version: 'v4.267',
    date: '2026-08-31',
    description: 'Startup Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Startup: resolve absolute serviceAccountKey path, working directories in launch_brain.ps1, and Turbopack root',
      'Deps: bump hpack 4.1.0->4.2.0 to satisfy h2==4.4.1 constraint (fixes Docker build)',
  ...
  _Release(
    version: 'v4.265',
    date: '2026-08-31',
    description: 'Attorney-portal Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Attorney-portal: guard empty token in initState, add no-token placeholder',
      'Attorney: ITEM B â€” SHA-256 token portal, snapshot allow-list, entitlements script',
  ...
  _Release(
    version: 'v4.264',
    date: '2026-08-31',
    description: 'Attorney Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Attorney: ITEM B â€” SHA-256 token portal, snapshot allow-list, entitlements script',
      'Security: ITEM A + C â€” is_demo backfill complete, rules hardened, Dependabot triage',
  ...
  _Release(
    version: 'v4.239',
    date: '2026-08-26',
    description: 'Collectibles Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Auto-versioning hook changes (v4.238)',
      'Collectibles: TEMPORARY productFamily guard in SlotResolver.isMatch -- PDF 5/19 -> 2/19',
  ...
  _Release(
    version: 'v4.234',
    date: '2026-08-26',
    description: 'Crash Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Crash: coerce Firestore int year to String in ProgramCoin.fromMap',
      'Catalog: pair 2026 US Mint product images and update release notes',
  ...
  _Release(
    version: 'v4.226',
    date: '2026-08-26',
    description: 'Deals Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Deals: update deal spotter links to live eBay search queries with dynamic encoding',
      'Invoice: add US Mint product catalog mapping and few-shot extraction rules',
  ...
  _Release(
    version: 'v4.225',
    date: '2026-08-26',
    description: 'Invoice Enhancements & Platform Updates',
    isLatest: false,
    changes: [
      'Invoice: add US Mint product catalog mapping and few-shot extraction rules',
      'Programs: Phase 1 + 1b coin program data and seed script overhaul',
